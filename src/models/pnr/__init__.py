...
from transformers import BertConfig, RobertaConfig, PreTrainedModel, AutoConfig, AutoModel, BertModel
...
class AlchemyPnRNet(AlchemyModel):
    ...
    def __init__(self):
        ...
        if "model_path" in self.model_cfg:
            ...
            self.module.fpn.encoder.trf = AutoModel.from_pretrained(self.model_cfg["plm_path"])
